...
async function main() {
      ...
      const [booking] = await db
        ...
        .values({
          ...
          eventDate: bookingInput.eventDate
            ? new Date(bookingInput.eventDate)
            : null,
  ...
  console.log(`Seeded ${insertedGuests.length} guest profiles`);
  console.log(`Seeded ${canonicalScenarios.length} canonical scenarios`);
}
